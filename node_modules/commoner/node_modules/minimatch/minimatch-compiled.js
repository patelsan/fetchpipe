...
;(function (require, exports, module, platform) {
  ...
  function braceExpand(_x, _x2) {
    ...
    _function: while (_again) {
      var pattern = _x,
          options = _x2;
      escaping = prefix = i = l = c = tail = numset = suf = start = needPadding = startWidth = padded = end = inc = set = i = ii = ll = i = depth = set = member = sawEnd = escaping = c = suf = addBraces = ret = i = l = ii = ll = undefined;
