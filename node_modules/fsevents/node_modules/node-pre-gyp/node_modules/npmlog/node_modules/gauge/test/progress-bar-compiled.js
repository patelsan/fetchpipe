...
var bar = new ProgressBar({ theme: ProgressBar.ascii }, C = {
  ...
  horizontalAbsolute: function horizontalAbsolute(col) {
...
test("hide", function (t) {
  ...
  bar.hide();
  isOutput(t, "hide while not showing", [["show"], // cursor
  ["horizontalAbsolute", 0], ["eraseLine"]]);
  cursor = [];
  bar.showing = true;
  bar.hide();
  isOutput(t, "hide while showing", [["show"], // cursor
  ["up", 1], ["horizontalAbsolute", 0], ["eraseLine"]]);
});
...
//# sourceMappingURL=progress-bar-compiled.js.map