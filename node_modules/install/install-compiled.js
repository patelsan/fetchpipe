...
(function (global, undefined) {
    ...
    global.install = function (id, module) {
        ...
        if (typeof id === "string" && module) {
            ...
            // installation, as soon as their requirements have been installed.
                ...
                if (qhead.next === qtail) flushQueue();
            }
    };
    ...
    function absolutize(id, baseId) {
        if (id.charAt(0) === ".") {
            ...
            id = "/" + baseId + "/../" + id;
            while (id != (baseId = id.replace(pathNormExp, "/"))) id = baseId;
            id = id.replace(/^\//, "");
        }
        return id;
    }
    ...
    function ready(module) {
        ...
        if (!module.seen && !hasOwn.call(module, "exports")) {
            ...
            if (!deps) {
                ...
                while (match = requireExp.exec(code)) deps[absolutize(match[1], module.id)] = true;
            }
