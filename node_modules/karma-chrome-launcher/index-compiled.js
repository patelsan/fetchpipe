...
var ChromeBrowser = function ChromeBrowser(baseBrowserDecorator, args) {
  ...
  this._getOptions = function (url) {
    ...
    return ['--user-data-dir=' + this._tempDir, '--no-default-browser-check', '--no-first-run', '--disable-default-apps', '--disable-popup-blocking', '--disable-translate'].concat(flags, [url]);
  };
};
...
var ChromeCanaryBrowser = function ChromeCanaryBrowser(baseBrowserDecorator, args) {
...
var DartiumBrowser = function DartiumBrowser() {
  ChromeBrowser.apply(this, arguments);
