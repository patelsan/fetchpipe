...
(function (window) {
   ...
   */
  var getGrepOption = function getGrepOption(clientArguments) {
   ...
   */
  var KarmaSpecFilter = function KarmaSpecFilter(options) {
   ...
   */
  var createSpecFilter = function createSpecFilter(config, jasmineEnv) {
