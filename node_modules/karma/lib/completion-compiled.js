...
var parseEnv = function parseEnv(argv, env) {
...
var opositeWord = function opositeWord(word) {
  if (word.charAt(0) !== '-') {
    return null;
  }
...
var sendCompletionNoOptions = function sendCompletionNoOptions() {};

var sendCompletion = function sendCompletion(possibleWords, env) {
...
var sendCompletionFiles = function sendCompletionFiles(env) {
...
var sendCompletionConfirmLast = function sendCompletionConfirmLast(env) {
  console.log(env.last);
};

var complete = function complete(env) {
  if (env.count === 1) {
