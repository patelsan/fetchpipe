...
var Pattern = function Pattern(pattern, served, included, watched, nocache) {
...
var UrlPattern = function UrlPattern(url) {
  Pattern.call(this, url, false, true, false, false);
};

var createPatternObject = function createPatternObject(pattern) {
...
var normalizeUrlRoot = function normalizeUrlRoot(urlRoot) {
...
var normalizeConfig = function normalizeConfig(config, configFilePath) {
  var basePathResolve = function basePathResolve(relativePath) {
  ...
  var createPatternMapper = function createPatternMapper(resolve) {
...
var parseConfig = function parseConfig(configFilePath, cliOptions) {
  var configModule;
  if (configFilePath) {
