...
var bindAllEvents = function bindAllEvents(object, context) {
  context = context || this;

  var bindMethod = function bindMethod(method) {
...
var bufferEvents = function bufferEvents(emitter, eventsToBuffer) {
  var listeners = [];
  var eventsToReply = [];
  var genericListener = function genericListener() {
