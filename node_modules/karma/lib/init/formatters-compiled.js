...
var isCoffeeFile = function isCoffeeFile(filename) {
  return COFFEE_REGEXP.test(filename);
};

var isLiveFile = function isLiveFile(filename) {
  return LIVE_REGEXP.test(filename);
};

var JavaScriptFormatter = function JavaScriptFormatter() {
  var quote = function quote(value) {
    return "'" + value + "'";
  };

  var quoteNonIncludedPattern = function quoteNonIncludedPattern(value) {
    return util.format('{pattern: %s, included: false}', quote(value));
  };

  var pad = function pad(str, _pad) {
    return str.replace(/\n/g, '\n' + _pad).replace(/\s+$/gm, '');
  };

  var formatQuottedList = function formatQuottedList(list) {
...
var CoffeeFormatter = function CoffeeFormatter() {
...
var LiveFormatter = function LiveFormatter() {
  JavaScriptFormatter.call(this);
...
//# sourceMappingURL=formatters-compiled.js.map