...
var PromiseContainer = function PromiseContainer() {
  var promise;
...
var serve404 = function serve404(response, path) {
  log.warn('404: ' + path);
  response.writeHead(404);
  return response.end('NOT FOUND');
};

var createServeFile = function createServeFile(fs, directory) {
...
var setNoCacheHeaders = function setNoCacheHeaders(response) {
  response.setHeader('Cache-Control', 'no-cache');
  response.setHeader('Pragma', 'no-cache');
  response.setHeader('Expires', new Date(0).toString());
};

var setHeavyCacheHeaders = function setHeavyCacheHeaders(response) {
