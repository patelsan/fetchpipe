...
var filePathToUrlPath = function filePathToUrlPath(filePath, basePath, urlRoot) {
...
var getXUACompatibleUrl = function getXUACompatibleUrl(url) {
  var value = '';
  var urlObj = urlparse(url);
  if (urlObj.query['x-ua-compatible']) {
...
var createKarmaMiddleware = function createKarmaMiddleware(filesPromise, serveStaticFile,
...
createKarmaMiddleware.$inject = ['filesPromise', 'serveStaticFile', 'config.basePath', 'config.urlRoot', 'config.client'];
