...
var createPreprocessor = function createPreprocessor(config, basePath, injector) {
  var alreadyDisplayedWarnings = {};
  var instances = {};
  var patterns = Object.keys(config);

  var instantiatePreprocessor = function instantiatePreprocessor(name) {
  ...
  return function preprocess(file, done) {
    ...
    var nextPreprocessor = function nextPreprocessor(error, content) {
      // normalize B-C
