...
var root = global || window || undefined;
...
// Constructor
var Server = function Server(cliOptions, done) {
...
Server.prototype._start = function (config, launcher, preprocess, fileList, webServer, capturedBrowsers, socketServer, executor, done) {
  var self = this;
  ...
  var afterPreprocess = function afterPreprocess() {
    if (config.autoWatch) {
  ...
  var emitRunCompleteIfAllBrowsersDone = function emitRunCompleteIfAllBrowsersDone() {
    // all browsers done
  ...
  var disconnectBrowsers = function disconnectBrowsers(code) {
