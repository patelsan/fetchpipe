...
var createCustomHandler = function createCustomHandler(customFileHandlers, /* config.basePath */basePath) {
...
var createWebServer = function createWebServer(injector, emitter, fileList) {
  ...
  var handler = connect().use(injector.invoke(runnerMiddleware.create)).use(injector.invoke(stripHostMiddleware.create)).use(injector.invoke(karmaMiddleware.create)).use(injector.invoke(sourceFilesMiddleware.create))
  ...
  .use(injector.invoke(createCustomHandler)).use(function (request, response) {
...
//# sourceMappingURL=web-server-compiled.js.map