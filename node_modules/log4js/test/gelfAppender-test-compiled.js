...
var vows = require('vows'),
    ...
    setupLogging = function setupLogging(options, category, compressedLength) {
  var fakeDgram = {
    sent: false,
    socket: {
      packetLength: 0,
      ...
      send: function send(pkt, offset, pktLength, port, host) {
        fakeDgram.sent = true;
        this.packet = pkt;
        this.offset = offset;
    ...
    createSocket: function createSocket(type) {
      this.type = type;
      return this.socket;
    }
  },
      fakeZlib = {
    gzip: function gzip(objectToCompress, callback) {
    ...
    error: function error(message) {
      ...
      fakeLayouts = {
    layout: function layout(type, options) {
      this.type = type;
...
vows.describe('log4js gelfAppender').addBatch({
  ...
  'with default gelfAppender settings': {
    ...
    'the dgram packet': {
      topic: function topic(setup) {
        return setup.dgram;
      },
      'should be sent via udp to the localhost gelf server': function shouldBeSentViaUdpToTheLocalhostGelfServer(dgram) {
      ...
      'should be compressed': function shouldBeCompressed(dgram) {
    ...
    'the uncompressed log message': {
      ...
      'should be in the gelf format': function shouldBeInTheGelfFormat(message) {
  ...
  'with a message longer than 8k': {
    ...
    'the dgram packet': {
      ...
      'should not be sent': function shouldNotBeSent(dgram) {
  ...
  'with non-default options': {
    ...
    'the dgram packet': {
      ...
      'should pick up the options': function shouldPickUpTheOptions(dgram) {
    ...
    'the uncompressed packet': {
      ...
      'should pick up the options': function shouldPickUpTheOptions(message) {
  ...
  'on process.exit': {
    ...
    'should close open sockets': function shouldCloseOpenSockets(setup) {
  ...
  'on zlib error': {
    ...
    'should output to console.error': function shouldOutputToConsoleError(setup) {
  ...
  'with layout in configuration': {
    ...
    'should pass options to layout': function shouldPassOptionsToLayout(setup) {
...
//# sourceMappingURL=gelfAppender-test-compiled.js.map