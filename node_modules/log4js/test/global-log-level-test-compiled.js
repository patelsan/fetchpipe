...
vows.describe('log4js global loglevel').addBatch({
  'global loglevel': {
    ...
    'set global loglevel on creation': function setGlobalLoglevelOnCreation(log4js) {
    ...
    'global change loglevel': function globalChangeLoglevel(log4js) {
      var log1 = log4js.getLogger('log1');
      var log2 = log4js.getLogger('log2');
      var level = 'OFF';
      if (log1.level.toString() == level) {
    ...
    'override loglevel': function overrideLoglevel(log4js) {
      var log1 = log4js.getLogger('log1');
      var log2 = log4js.getLogger('log2');
      var level = 'OFF';
      if (log1.level.toString() == level) {
    ...
    'preload loglevel': function preloadLoglevel(log4js) {
      var log1 = log4js.getLogger('log1');
      var level = 'OFF';
      if (log1.level.toString() == level) {
        level = 'TRACE';
    ...
    'set level on all categories': function setLevelOnAllCategories(log4js) {
      // Get 2 loggers
      var log1 = log4js.getLogger('log1');
      var log2 = log4js.getLogger('log2');
...
//# sourceMappingURL=global-log-level-test-compiled.js.map