...
function setupLogging(category, options) {
  ...
  var fakeDgram = {
    createSocket: function createSocket(type) {
      return {
        send: function send(buffer, offset, length, port, host, callback) {
...
vows.describe('logstashUDP appender').addBatch({
  'when logging with logstash via UDP': {
    ...
    'an UDP packet should be sent': function anUDPPacketShouldBeSent(topic) {
  ...
  'when missing some options': {
    ...
    'it sets some defaults': function itSetsSomeDefaults(topic) {
      var json = JSON.parse(topic.results.buffer.toString());
...
//# sourceMappingURL=logstashUDP-test-compiled.js.map