...
vows.describe('DateRollingFileStream').addBatch({
  'arguments': {
    ...
    'should take a filename and a pattern and return a WritableStream': function shouldTakeAFilenameAndAPatternAndReturnAWritableStream(stream) {
  ...
  'default arguments': {
    ...
    'pattern should be .yyyy-MM-dd': function patternShouldBeYyyyMMDd(stream) {
  ...
  'with stream arguments but no pattern': {
    ...
    'should use default pattern': function shouldUseDefaultPattern(stream) {
      assert.equal(stream.pattern, '.yyyy-MM-dd');
    }
  },
  ...
  'with a pattern of .yyyy-MM-dd': {
    ...
    'should create a file with the base name': {
      topic: function topic(stream) {
        fs.readFile(__dirname + '/test-date-rolling-file-stream-5', this.callback);
      },
      'file should contain first message': function fileShouldContainFirstMessage(result) {
    ...
    'when the day changes': {
      ...
      'the file without a date': {
        ...
        'should contain the second message': function shouldContainTheSecondMessage(contents) {
      ...
      'the file with the date': {
        ...
        'should contain the first message': function shouldContainTheFirstMessage(contents) {
...
//# sourceMappingURL=DateRollingFileStream-test-compiled.js.map