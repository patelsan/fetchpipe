...
vows.describe('RollingFileStream').addBatch({
  'arguments': {
    ...
    'should take a filename, file size (bytes), no. backups,  return Writable': function shouldTakeAFilenameFileSizeBytesNoBackupsReturnWritable(stream) {
    ...
    'with default settings for the underlying stream': function withDefaultSettingsForTheUnderlyingStream(stream) {
  ...
  'with stream arguments': {
    ...
    'should pass them to the underlying stream': function shouldPassThemToTheUnderlyingStream(stream) {
  ...
  'without size': {
    ...
    'should throw an error': function shouldThrowAnError(err) {
  ...
  'without number of backups': {
    ...
    'should default to 1 backup': function shouldDefaultTo1Backup(stream) {
  ...
  'writing less than the file size': {
    ...
    'should write to the file': function shouldWriteToTheFile(contents) {
    ...
    'the number of files': {
      ...
      'should be one': function shouldBeOne(files) {
  ...
  'writing more than the file size': {
    topic: function topic() {
      ...
      async.each([0, 1, 2, 3, 4, 5, 6], function (i, cb) {
    ...
    'the number of files': {
      ...
      'should be two': function shouldBeTwo(files) {
        assert.equal(files.filter(function (file) {
    ...
    'the first file': {
      ...
      'should contain the last two log messages': function shouldContainTheLastTwoLogMessages(contents) {
    ...
    'the second file': {
      ...
      'should contain the first five log messages': function shouldContainTheFirstFiveLogMessages(contents) {
  ...
  'when many files already exist': {
    ...
    'the files': {
      ...
      'should be rolled': function shouldBeRolled(files) {
...
//# sourceMappingURL=rollingFileStream-test-compiled.js.map