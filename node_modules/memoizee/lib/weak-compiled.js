...
module.exports = function (memoize) {
	return function (fn /*, options*/) {
		...
		if (length === 1 && !normalizer && !(options.async && extensions.async) && !(options.dispose && extensions.dispose) && !(options.maxAge && extensions.maxAge) && !(options.max && extensions.max) && !(options.refCounter && extensions.refCounter)) {
...
//# sourceMappingURL=weak-compiled.js.map