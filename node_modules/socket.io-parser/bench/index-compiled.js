...
module.exports = function (callback) {
  ...
  suite.add('small json parse', { defer: true, fn: function fn(deferred) {
      var packet = {
        type: parser.EVENT,
        nsp: '/bench',
        data: dataObject
    ...
    } }).add('big json parse', { defer: true, fn: function fn(deferred) {
      var packet = {
        type: parser.EVENT,
        nsp: '/bench',
        data: bigArray
      ...
      test(packet, deferred);
    } }).add('json with small binary parse', { defer: true, fn: function fn(deferred) {
      var packet = {
        type: parser.EVENT,
        nsp: '/bench',
      ...
      test(packet, deferred);
    } }).add('json with big binary parse', { defer: true, fn: function fn(deferred) {
      var bigBinaryData = {
