...
Object.defineProperty(Agent.prototype, 'os', {
  get: function lazyparse() {
    ...
    return Object.defineProperty(this, 'os', {
      value: !parser || !res ? new OperatingSystem() : new OperatingSystem(res[1], parser[2] || res[2], parser[3] || res[3], parser[4] || res[4])
    }).os;
  },
...
Object.defineProperty(Agent.prototype, 'device', {
  get: function lazyparse() {
    ...
    return Object.defineProperty(this, 'device', {
      value: !parser || !res ? new Device() : new Device(res[1], parser[2] || res[2], parser[3] || res[3], parser[4] || res[4])
    }).device;
  },
...
exports.parse = function parse(userAgent, jsAgent) {
  ...
  for (; i < length; i++) {
    if (res = parsers[i][0].exec(userAgent)) {
      ...
      if (parser[1]) res[1] = parser[1].replace('$1', res[1]);
      if (!jsAgent) return new Agent(res[1], parser[2] || res[2], parser[3] || res[3], parser[4] || res[4], userAgent);
